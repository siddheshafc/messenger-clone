...
function App() {
  ...
  const [messages, setMessages] = useState([
    {username:'Siddhesh', message:'Hii'},
    {username:'Sanjana', message:'Hey'}]);
  ...
  return (
    ...
    <form className="app__form">
      ...
      <FormControl className="app__formControl">
        ...
        <IconButton className="app_iconButton" variant="contained" disabled={!input} type="submit" onClick={sendMessage}>
          <SendIcon />
        </IconButton>
